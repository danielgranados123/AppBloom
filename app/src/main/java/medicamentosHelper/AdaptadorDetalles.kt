...
class AdaptadorDetalles(private var Datos: List<DataClassMedicamentos>) : RecyclerView.Adapter<ViewHolderDetalles>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderDetalles {
        val vista =            LayoutInflater.from(parent.context).inflate(R.layout.item_card_medicamentos_detalles, parent, false)
        return ViewHolderDetalles(vista)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolderDetalles, position: Int) {
